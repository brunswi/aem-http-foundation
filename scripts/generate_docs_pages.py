...
def main() -> None:
    ...
    core_doc.write_text(
        "<!-- Generated by scripts/generate_docs_pages.py — edit core/README.md, not this file. -->\n\n"
        + core_out,
        encoding="utf-8",
    )

    print(f"Wrote {index.relative_to(REPO_ROOT)} and {core_doc.relative_to(REPO_ROOT)}")
